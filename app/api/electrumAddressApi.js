...
function connectToServers() {	
	return new Promise(function(resolve, reject) {
		...
		debugLog(`Attempting to connect to ${config.electrumServers.length} Electrum servers: ${JSON.stringify(config.electrumServers)}`);
...
function connectToServer(host, port, protocol) {
	...
	return new Promise(function(resolve, reject) {
		...
		var actualProtocol = protocol || defaultProtocol;
